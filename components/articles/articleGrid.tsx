...
const articles = [
  ...
  },
  {
    ...
    excerpt:
      "Navigate market volatility with smart diversification. Explore asset allocation strategies.",
  },
  {
    ...
    excerpt:
      "Master the art of cash flow management with proven techniques that keep your business healthy.",
  },
  {
    ...
    excerpt:
      "Unlock the full potential of your retirement savings with strategies to maximize employer matching.",
  },
  {
    ...
    excerpt:
      "Our chief economist analyzes key market trends and what they mean for your investment portfolio.",
  },
  {
    ...
    excerpt:
      "Practical steps to improve your credit score and unlock better rates on loans.",
  },
];
...
const ArticleGrid = ({ activeCategory }: { activeCategory: string }) => {
  ...
  return (
    <section className="px-[5%] md:px-0 pt-10 pb-24 max-w-7xl mx-auto min-h-150">
      <motion.div
        variants={container}
        initial="hidden"
        animate="show"
      ...
      >
        {filteredArticles.map((article, i) => (
          ...
          >
            <CardHeader>
              <div
                className="h-62.5 bg-cover bg-center relative"
            ...
            <CardContent className="p-10 flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 flex">
                <Button as="a" href="#" variant="link" className="px-0 py-0">
                  Read More
                </Button>
              </div>
            </CardContent>
