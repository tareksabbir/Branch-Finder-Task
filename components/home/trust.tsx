...
const Trust = () => {
  ...
  return (
    <section id="about" className="py-32 px-[5%] bg-warm-white">
      <div
        ref={ref}
        className="grid grid-cols-1 lg:grid-cols-2 gap-20 max-w-350 mx-auto items-center"
      >
        <div
          className="h-150 bg-cover bg-center rounded-[30px] shadow-2xl"
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1551135049-8a33b5883817?w=1000&q=90')",
          }}
        />
        ...
        <div>
          ...
          <p className="text-lg text-slate font-light leading-relaxed mb-6">
            For over three decades, we've been more than a bank. We're a partner
            in your financial journey, committed to transparency and innovation.
          </p>
          ...
          <div className="grid grid-cols-2 gap-8 mt-12">
            {stats.map((s, i) => (
              ...
              >
                <span className="font-playfair text-[3rem] font-bold text-gold block mb-2">
                  {s.num}
                </span>
