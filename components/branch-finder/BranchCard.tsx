...
export const BranchCard = memo(
  ...
  // Custom comparator: compare by primitives to avoid re-renders
  // when calculateDistances creates new branch objects via spread
  (prevProps, nextProps) =>
    prevProps.branch.id === nextProps.branch.id &&
    prevProps.branch.distance === nextProps.branch.distance &&
